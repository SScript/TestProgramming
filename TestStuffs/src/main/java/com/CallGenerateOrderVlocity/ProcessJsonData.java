 ...
 */
package com.CallGenerateOrderVlocity;
...
public class ProcessJsonData {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < itemcount; i++) {
            ...
            val = GetJsonObjectValue(itemdata, "ProductSubType", "ProductSubType");
            ...
            try {
                ...
                //result.RetCode = "SOA_154[099]";
                //result.RetMsg = "Kļūda: " + ee.getMessage();
            }

            sb.append("</listOfOrderItemXA>");

            // SOAIP-2116, SOAIP-2335
            try {
                orderPromotionData = itemdata.getJSONObject("orderPromotion");
                sb.append("<promotionList>");
                sb.append("<promoItem>");
                sb.append(GetJsonObjectValue(orderPromotionData, "PromotionActionCode", "promotionActionCode"));
