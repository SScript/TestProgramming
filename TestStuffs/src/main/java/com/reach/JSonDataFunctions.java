...
public class JSonDataFunctions {
    ...
    * */
    ...
    // FulfilmentStatus <> 'InComplete' un ðîm OrderItem ir child OrderItem ar OrderItem ar ProductCode = 'PD_TELCO_INSTALL_PACKAGE' (SOAIP-2257)
    ...
    // FulfilmentStatus <> 'InComplete' un ðîm OrderItem ir child OrderItem ar ProductSubType = 'Installation' and ServiceType = 'Fitter'
    ...
    public String GetServiceStartDate(JSONArray orderdataitems) throws Exception {
        ...
        // ServiceStartDate ir katrâ orderitemâ
        for (int i = 0; i < itemcount; i++) {
            d = orderdataitems.getJSONObject(i);
