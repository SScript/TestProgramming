...
public class ProcessJsonDataReach_0 {
            ...
            if (isOrderData) {
                ...
                if ("VLOCITY_NOTIF_2".equals(NotificationCommType)) {
                    ...
                    sb.append("<DynamicParameter>")
                      ...
                      .append(", ")
                      .append(GetJsonAtrrObjectStringValue(orderdata, "VLOrderContactPhone", true))
                      .append(", ")
                      .append(GetJsonAtrrObjectStringValue(orderdata, "VLOrderContactEmail", true))
                      .append("</Value>")
                ...
                // AcceptanceAddress
                sb.append(AddDinamicParam("AcceptanceDueDate", GetAcceptanceAddress(orderdata)));
     ...
     *  then  OrderItems.ObjectAddress - konkatinēt no visiem OrderItem, atdalītājs - komats.
     * @param orderData
     * @return
     */
    ...
    private String GetOrderSubTypeValue() throws Exception {
        ...
        for (int i = 0; i < itemcount; i++) {
            itemdata = orderdataitems.getJSONObject(i);
            productType = GetJsonAtrrObjectStringValue(itemdata, "OrderSubType", true);
    ...
    /**
     * ServiceNumber, where  ProductType = SplitPayment
     * @return 
     */
        ...
        for (int i = 0; i < itemcount; i++) {
            ...
            if ("ConsumerGoods".equals(productType) || "Insurance".equals(productType) ||
                ...
                */
                ...
                String v = GetJsonAtrrObjectStringValue(itemdata, "OrderSubType", false);
                if ("Delete Insurance/Warranty".equals(v)) {
