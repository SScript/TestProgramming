...
public class ProcessJsonDataReach extends JSonDataFunctions {
    ...
    public Resp ProcessJsonData(String jsonData) throws Exception {
        ...
        try {
            ...
            // SOAIP-1791 - add AuthenticationMethod and CustomerType (pārsaucam par CustomerStatusType)
            ...
            // Jāpadod ja no Vlocity saņemta struktūra Order (SOAIP-1019) un nav TELCO order (SOAIP-2257)
            if (isOrderData) {
            ...
            if (isOrderData || isOrderUpdateStructureAdded) {
                ...
                if ("OrderSummary_Telco".equalsIgnoreCase(actcode)) {
                    ...
                    if ("ChangeAgreedDate_telco".equalsIgnoreCase(actcode)) {
                        ...
                        if (!"Ierīkošana ar meistaru".equals(installationType)) {
            ...
            if (isOrderData) {
                ...
                if ("OrderSummary_Telco".equalsIgnoreCase(actcode)) {
                    ...
                    // Ja ActionCode = "ChangeAgreedDate_telco" un OrderUpdate.Item.InstallationType = "Ierīkošana ar meistaru", tad OrderUpate.Item.SAAddress
                    if ("ChangeAgreedDate_telco".equalsIgnoreCase(actcode)) {
                        String installationType = "";
                        installationType = GetJsonAtrrObjectStringValue(orderUpdateItemdata, "InstallationType", true);
                        if ("Ierīkošana ar meistaru".equals(installationType)) {
    ...
    private String GetOrderSubTypeValue() throws Exception {
        ...
        for (int i = 0; i < itemcount; i++) {
            ...
            // Ja ProductType = Telco, tad OrderSubType no pirmā  OrderItem ar ProductSubType = Offer un ProductCode < 'PD_TELCO_TECH_LINE_NONCOMMERCIAL' (SOAIP-2257)
    ...
    private String GetVLOrderItemXFields(JSONObject obj) throws Exception {
        ...
        for (int i = 0; i < itemcount; i++) {
            ...
            // flag domāts priekš tā, lai ir korekta numerācija vlOrderItemX ar variabli 'c'
            ...
            if ("Telco".equals(productType)) {
                ...
                // SOAIP-2257 izņemot fulfilmentstatus InComplete
            ...
            if ("Telco".equals(productType) && !"InComplete".equals(fulfilmentStatus) && "Offer".equals(productSubType) && !"PD_TELCO_TECH_LINE_NONCOMMERCIAL".equals(productCode)) {
                ...
                if ("OrderSummary_Telco".equalsIgnoreCase(productActionCode)) {
                    ...
                    for (int j = 0; j < itemcount; j++) {
                        ...
                        PrdSubType = GetJsonAtrrObjectStringValue(d, "ProductSubType", false);
                        FulFilSt = GetJsonAtrrObjectStringValue(d, "FulfilmentStatus", false);

                        if ("Telco".equals(PrdType) && !"InComplete".equals(FulFilSt) && "Offer".equals(PrdSubType)
                                && !"PD_TELCO_TECH_LINE_NONCOMMERCIAL".equals(PrdCode)) {
