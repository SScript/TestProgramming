...
public class ProcessJsonDataReachRun {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filename = "jsonreach.json";
        ...
        ProcessJsonDataReach_1 p1 = new ProcessJsonDataReach_1();
        ProcessJsonDataReach_2 p2 = new ProcessJsonDataReach_2();
        Resp res1;
        Resp res2;
        ...
        FileUtils.writeStringToFile(new File("C:/TestProgramming/TestProgramming/TestStuffs/src/main/java/com/reach/" + filename + "Res1.xml"),
