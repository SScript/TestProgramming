    ...
    public Resp ProcessJsonData(String jsonData) throws Exception {
        ...
        try {
            ...
            if (isOrderData) {
                ...
                //GetOrderItemFieldValueByProductType("Telco", "VLOrderMonthlyTotal");
                // VLOrderMonthlyTotal
        ...
        if (isOrderItems) {
            try {
                for (int i = 0; i < itemc; i++) {
                    ...
                    if (prdTypeValue.equalsIgnoreCase(prdType)) {return true;}
                }
    ...
    private String GetVLOrderItemXFields(JSONObject obj) throws Exception {
        ...
        for (int i = 0; i < itemcount; i++) {
            ...
            if ("Telco".equals(productType) && "Offer".equals(productSubType)) {
                ...
                for (int j = 0; j < itemcount; j++) {
                    ...
                    if ("true".equalsIgnoreCase(ShowInVlocityOrderSummaryFlag)
                        ...
                        fieldName = "VLOrderItem" + (i + 1)  + "Product" + (j + 1) + "RC";
            ...
            if ("PD_TELCO_OTT_CHANNEL".equalsIgnoreCase(productCode)) {
                fieldName = "VLOrderItem" + (i + 1)  + "TetLogin";
