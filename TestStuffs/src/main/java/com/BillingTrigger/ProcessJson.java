...
public class ProcessJson {
    ...
    public Resp doTransform(String inJsonData, String excludeStrs, String containsOrEquals, String caller) {
        ...
        try {
            ...
            // uzreiz dabûnam orderId un orderNumber
            ...
            if (!"Split payment".equalsIgnoreCase(orderedService)) {
                // priekð Electricity - <ItemServiceAddressKey>
                AccountAddressId = GetItemServiceAddressKey();
            } else {
                // "AddressKey" nav obligâts
            ...
            if ("Split payment".equalsIgnoreCase(orderedService)) {
                ...
                try {
                    switch (paymentMode) {
                        ...
                        case "Full Payment":
                            ...
                            // SOAIP-1950 full payment gadîjumâ vajadzçja serviceno padot Vlocity header lîmenî
                            break;
                        default:
                ...
                // vajag tikai ciparu, kas ir lîdz "-" simbolam
            ...
            // jâbût formâtâ ‘DD/MM/YYYY’. Ienâkoðias - YYYY-MM-DD.
            if ("Split payment".equalsIgnoreCase(orderedService)) {
                s = GetOrderFieldFirstLEvelValue("BillActivationDate", true);
            } else {
                // jânem no "Electricity.RootObject.BillActivationDate"
            ...
            if ("Split payment".equalsIgnoreCase(orderedService)) {
                ...
                GetOrderItemLevelAtrrDinamicValue("CE Restructuring", "Atlikðanas procenti", "ORD_PAYMENT_DELAY_PERCENT");
                // CE Restructuring.PaymentDelayMonths
                GetOrderItemLevelAtrrDinamicValue("CE Restructuring", "Atlikðanas mçneðu skaits", "ORD_PAYMENT_DELAY_MONTHS");
                // CE Restructuring.RepayMonths
                GetOrderItemLevelAtrrDinamicValue("CE Restructuring", "Uzkrâto summu izmaksa mçneðos", "ORD_REPAY_MONTHS");
            ...
            if ("Electricity".equalsIgnoreCase(orderedService) && isOrderItems) {
                ...
                //pretejâ gadijumâ - value = <OrderItem.OrderPricing.Amount>
    ...
    private String TranslateOrderPricingSource(String source, JSONObject itemdata) throws Exception {
        // ar switchu laikam nesanâktu, saglabâju tikmçr tepat ieprieksçjo gabalu
                    ...
                    for (int j = 0; j < itempriccount; j++) {
                        ...
                        offerPriceObj.put(
                                new JSONObject()
                                        ...
                                        // ðis tika izòemts ar SOAIP-1943, pagaidâm atstâju aizkomentçtu
                ...
                if (itemSubtypeCompare.equalsIgnoreCase(prdtSubType)) {
                    try {
                        if ("ORDER_LINE_PLAN_CODE".equalsIgnoreCase(field)) {
                            // ðis ir jâòem, kur subtype ir "Plan"
                            // no itemdatiem
    ...
    /**
     * Order pirmâ lîmeòa parametrs
     * Ja ir, tad agrieþ vçrtîbu, ja nav parametra, tad vçrtîba ir tukðums
     *
     * @return
     */
    ...
    /**
     * Order pirmâ lîmeòa atribûtu parametrs
     *
     * @return
     */
    ...
    private String GetOrderItemLevelValue(String productType, String atrribute) {
        ...
        if (isOrderItems) {
            int itemcount = orderdataitems.length();
            // meklçjam atbilsoðo item pçc productType
            String ProductType = "";
            int counter = 0;
            for (int i = 0; i < itemcount; i++) {
                itemdata = orderdataitems.getJSONObject(i);
        ...
        if (isOrderItems) {
            ...
            for (int i = 0; i < itemcount; i++) {
                ...
                if (productType.equals(productTypeValue)) {
                    ...
                    // ja obligâts un tukðs, tad error
                    if (mandatory && isEmptyOrNull(val)) {
                        throw new Exception("Field " + field + " is mandatory");
                    } else {
            ...
            if (!foundinitemsvalue) {
                ...
                if ("Split payment".equalsIgnoreCase(orderedService) && "ORD_ORDERITEMID".equalsIgnoreCase(key)) {
                    // meklçjam pirmo ar Order Item ar ProductType = ConsumerGoods
    ...
    private void GetOrderItemLevelAtrrDinamicValue(String productType, String atrribute, String key) {
        ...
        if (isOrderItems) {
            ...
            // var bût, ka neatrod ProductType, tad arî vaig pielikt tukðu
