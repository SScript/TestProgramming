...
public class FavoritesList<E> {
  ...
  // nonpublic utilities
  /**
   * Provides shorthand notation to retrieve user's element stored at Position
   * p.
   */
  ...
  /**
   * Accesses element e, thereby increasing its access count. If e is new, its
   * count will be 1 after this operation.
   */
