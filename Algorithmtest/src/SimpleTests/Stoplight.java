...
/**
 * This class represents a simple implementation of a stoplight. The client can
 * determine the current state of the stoplight by calling stoplight.getState()
 * and change it to the next color in the sequence (GREEN -> YELLOW -> RED ->
 * GREEN) by calling stoplight.advance().
 */
