 ...
 */
package chapter10_Maps_HashTables_SkipLists;
...
public class CostPerformanceDatabase {
  ...
  /**
   * Returns the (cost,performance) entry with largest cost not exceeding c. (or
   * null if no entry exist with cost c or less).
   */
